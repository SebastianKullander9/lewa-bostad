    ...
    return (
        <section className="no-section-p lg:inner-section-h my-24 flex flex-col justify-center">
            <div className="grid grid-cols-12 inner-section-p">
                ...
                <div className="col-span-12 md:col-span-8 md:col-start-3 mb-8 lg:mb-24 xl:mb-36">
                ...
                <div className="col-span-12 md:col-span-8 md:col-start-3 grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-4 gap-base">
                    <KeyFigure
                        value="3 300"
                        suffix="St"
